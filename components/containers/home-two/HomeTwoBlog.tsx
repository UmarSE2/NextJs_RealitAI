...
import three from "../../../public/images/blog/two.png";
          ...
          <SwiperSlide>
            <div className="blog-two__slider-single topy-tilt">
              ...
              <div className="blog__single-content">
                <h4>
                  <Link href="blog-single">
                    Tech Talk: Insights and Strategies for Optimizing IT
                    Infrastructure
                  </Link>
                </h4>
          ...
          <SwiperSlide>
            <div className="blog-two__slider-single topy-tilt">
              ...
              <div className="blog__single-content">
                <h4>
                  <Link href="blog-single">
                    Mastering Cybersecurity: Tips and Best Practices for
                    Businesses
                  </Link>
                </h4>
                <div className="blog__single-meta">
          ...
          <SwiperSlide>
            <div className="blog-two__slider-single topy-tilt">
              ...
              <div className="blog__single-content">
                <h4>
                  <Link href="blog-single">
                    Navigating the Future: Trends and Innovations in AI
                  </Link>
                </h4>
                <div className="blog__single-meta">
                  <Link href="blog" className="sub-title">
          ...
          <SwiperSlide>
            <div className="blog-two__slider-single topy-tilt">
              ...
              <div className="blog__single-content">
                <h4>
                  <Link href="blog-single">
                    IoT Integration: Connecting Devices for a Smarter World
                  </Link>
                </h4>
                <div className="blog__single-meta">
                  <Link href="blog" className="sub-title">
          ...
          <SwiperSlide>
            <div className="blog-two__slider-single topy-tilt">
              ...
              <div className="blog__single-content">
                <h4>
                  <Link href="blog-single">
                    The Power of Big Data: Transforming Business Intelligence
                  </Link>
                </h4>
                <div className="blog__single-meta">
                  <Link href="blog" className="sub-title">
          ...
          <SwiperSlide>
            <div className="blog-two__slider-single topy-tilt">
              ...
              <div className="blog__single-content">
                <h4>
                  <Link href="blog-single">
                    AI and Machine Learning: Revolutionizing the Tech Landscape
                  </Link>
                </h4>
                <div className="blog__single-meta">
                  <Link href="blog" className="sub-title">
          ...
          <SwiperSlide>
            <div className="blog-two__slider-single topy-tilt">
              ...
              <div className="blog__single-content">
                <h4>
                  <Link href="blog-single">
                    Cloud Computing Unleashed: Maximizing Efficiency and
                    Scalability
                  </Link>
                </h4>
                <div className="blog__single-meta">
